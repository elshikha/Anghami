...
namespace anghami {
	...
	/// <summary>
	/// Summary for hiphopclassics
	/// </summary>
	public ref class hiphopclassics : public System::Windows::Forms::Form
	{
	public:
		Form^ obj;
		hiphopclassics(void)
		...
		hiphopclassics(Form^ obj1) {
			obj = obj1;
			InitializeComponent();
		}/*/
		hiphopclassics(int^ val,int^ prog,bool^ mute,bool^playpause) {
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(hiphopclassics::typeid));
			...
			this->indaclublabel->Size = System::Drawing::Size(1044, 46);
			this->indaclublabel->TabIndex = 6;
			this->indaclublabel->Text = L"In Da Club                                       50 Cent           3:13";
			this->indaclublabel->Click += gcnew System::EventHandler(this, &hiphopclassics::indaclublabel_Click);
			// 
			// smackthatlabel
			// 
			...
			this->smackthatlabel->Size = System::Drawing::Size(1039, 46);
			this->smackthatlabel->TabIndex = 7;
			this->smackthatlabel->Text = L"Smack That (feat. Eminem)            AKON              3:32";
			this->smackthatlabel->Click += gcnew System::EventHandler(this, &hiphopclassics::smackthatlabel_Click);
			// 
			// diggerlabel
			// 
			...
			this->diggerlabel->Size = System::Drawing::Size(1031, 46);
			this->diggerlabel->TabIndex = 8;
			this->diggerlabel->Text = L"Gold Digger (feat. Jamie Foxx)       Kanye West    3:27";
			this->diggerlabel->Click += gcnew System::EventHandler(this, &hiphopclassics::diggerlabel_Click);
			// 
			// mocklabel
			// 
			...
			this->mocklabel->Size = System::Drawing::Size(1056, 46);
			this->mocklabel->TabIndex = 9;
			this->mocklabel->Text = L"Mockingbird                                     Eminem           4:10";
			this->mocklabel->Click += gcnew System::EventHandler(this, &hiphopclassics::mocklabel_Click);
			// 
			// goodday
			// 
			...
			this->goodday->Size = System::Drawing::Size(1047, 46);
			this->goodday->TabIndex = 10;
			this->goodday->Text = L"It Was A Good Day                          Ice Cube         4:20";
			this->goodday->Click += gcnew System::EventHandler(this, &hiphopclassics::label1_Click);
			// 
			// startqueue
			// 
			...
			this->startqueue->Click += gcnew System::EventHandler(this, &hiphopclassics::startqueue_Click);
			// 
			// play
			// 
			...
			this->play->Click += gcnew System::EventHandler(this, &hiphopclassics::play_Click);
			// 
			// volumecontrol
			// 
			...
			this->volumecontrol->Scroll += gcnew System::EventHandler(this, &hiphopclassics::volumecontrol_Scroll);
			// 
			// progressBar1
			// 
			...
			this->progressBar1->MouseClick += gcnew System::Windows::Forms::MouseEventHandler(this, &hiphopclassics::progressBar1_MouseClick);
			// 
			// playprev
			// 
			...
			this->playprev->Click += gcnew System::EventHandler(this, &hiphopclassics::playprev_Click);
			// 
			// playnext
			// 
			...
			this->playnext->Click += gcnew System::EventHandler(this, &hiphopclassics::playnext_Click);
			// 
			// volume
			// 
			...
			this->volume->Click += gcnew System::EventHandler(this, &hiphopclassics::volume_Click);
			// 
			// albumcover
			// 
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &hiphopclassics::timer1_Tick);
			// 
			// explore
			// 
			...
			this->explore->Click += gcnew System::EventHandler(this, &hiphopclassics::explore_Click);
			// 
			// yourlibrary
			// 
			...
			this->yourlibrary->Click += gcnew System::EventHandler(this, &hiphopclassics::yourlibrary_Click);
			// 
			// artist
			// 
			...
			this->reset->Click += gcnew System::EventHandler(this, &hiphopclassics::reset_Click);
			// 
			// rand2
			// 
			...
			this->rand2->Click += gcnew System::EventHandler(this, &hiphopclassics::rand2_Click);
			// 
			// rand
			// 
			...
			this->rand->Click += gcnew System::EventHandler(this, &hiphopclassics::rand_Click);
			// 
			// search_box
			// 
			...
			this->Name = L"hiphopclassics";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"anghami";
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &hiphopclassics::hiphopclassics_FormClosing);
			this->Load += gcnew System::EventHandler(this, &hiphopclassics::hiphopclassics_Load);
...
#pragma endregion
		...
		void mp3(int who) {
			...
			if (who == 1) mciSendStringA("open \"In Da Club.mp3\" type mpegvideo alias mp3", nullptr, 0, nullptr);
			if (who == 2) mciSendStringA("open \"Smack That.mp3\" type mpegvideo alias mp3", nullptr, 0, nullptr);
			if (who == 3) mciSendStringA("open \"Gold Digger.mp3\" type mpegvideo alias mp3", nullptr, 0, nullptr);
			if (who == 4) mciSendStringA("open \"Mockingbird.mp3\" type mpegvideo alias mp3", nullptr, 0, nullptr);
			if (who == 5) mciSendStringA("open \"It Was A Good Day.mp3\" type mpegvideo alias mp3", nullptr, 0, nullptr);
...
private: System::Void indaclublabel_Click(System::Object^ sender, System::EventArgs^ e) {
	Bitmap^ img = gcnew Bitmap("in_da_club.png");
	albumcover->BackgroundImage = img;
	trackname->Text = "In Da Club";
	artist->Text = "50 Cent";
...
private: System::Void smackthatlabel_Click(System::Object^ sender, System::EventArgs^ e) {
	Bitmap^ img = gcnew Bitmap("smack_that.png");
	albumcover->BackgroundImage = img;
	trackname->Text = "Smack That";
	artist->Text = "AKON";
	progressBar1->Value = 0;
	progress = 0;
	end->Text = "03:32";
...
private: System::Void diggerlabel_Click(System::Object^ sender, System::EventArgs^ e) {
	Bitmap^ img = gcnew Bitmap("gold_digger.png");
	albumcover->BackgroundImage = img;
	trackname->Text = "Gold Digger";
...
private: System::Void mocklabel_Click(System::Object^ sender, System::EventArgs^ e) {
	Bitmap^ img = gcnew Bitmap("mockingbird.png");
	albumcover->BackgroundImage = img;
	trackname->Text = "Mockingbird";
	artist->Text = "Eminem";
	progressBar1->Value = 0;
	progress = 0;
	end->Text = "04:10";
...
private: System::Void label1_Click(System::Object^ sender, System::EventArgs^ e) {
	Bitmap^ img = gcnew Bitmap("It Was A Good Day.png");
	albumcover->BackgroundImage = img;
	trackname->Text = "It Was A Good Day";
	artist->Text = "Ice Cube";
	progressBar1->Value = 0;
	progress = 0;
	end->Text = "04:20";
	index = 1;
